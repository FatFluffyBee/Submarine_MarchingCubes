Shader "Unlit/VertexOffset"
{
    Properties //input data 
    {
        ...
        _WaveAmplitude("WaveAmplitude", Range(0, 2)) = 0.2
    }
    SubShader
    {
        Tags { "RenderType"="Opaque" //tagging for post process effect
                "Queue" = "Geometry" //set the type of queue the shader will be (so after opaque)
            }
